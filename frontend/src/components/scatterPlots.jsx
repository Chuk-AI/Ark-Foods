...
function ScatterPlot() {
  ...
  const commodities = ['Anaheim', 'Cubanelles', 'Fresno', 'Habanero', 'Hungarian Wax', 'Jalapeno', 'Long Hot', 'Poblano', 'Serrano', 'Shishito']; // Replace with actual commodity list

  const fetchScatterPlot = () => {
    const endpoint = apiType === 'terminal' ? '/api/terminal_scatterplot_matrix' : '/api/shipping_scatterplot_matrix';
  ...
  return (
    <div className="scatter-container">
      ...
      <div className="scatter-filter">
        ...
        <div>
          <label>
            <input type="radio" value="terminal" checked={apiType === 'terminal'} onChange={() => setApiType('terminal')} />
            Terminal Scatter Plot
          </label>
          <label>
            <input type="radio" value="shipping" checked={apiType === 'shipping'} onChange={() => setApiType('shipping')} />
