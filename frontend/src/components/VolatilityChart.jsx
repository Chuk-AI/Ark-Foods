...
const VolatilityChart = () => {
  ...
  useEffect(() => {
    if (volatilityChart && volatilityData) {
      const resize = () => {
        const baseWidth =
          volatilityChartRef.current.parentNode.parentNode.offsetWidth;
        const dataLength = volatilityData.labels.length;

        // Different width per point based on time frame
        const pointWidth =
          viewType === "candlestick"
            ? appliedVolatilityFilters.timeFrame === "1m"
              ? 70
              : appliedVolatilityFilters.timeFrame === "14d"
                ? 40
                : appliedVolatilityFilters.timeFrame === "7d"
                  ? 30
                  : appliedVolatilityFilters.timeFrame === "3d"
                    ? 25
                    : 20
            : 0;
    ...
    appliedVolatilityFilters.timeFrame,
    volatilityChart,
    volatilityData,
    viewType,
  ]);
  ...
  const fetchVolatilityData = async (filters) => {
    const { commodity, cities, timeFrame, startDate, endDate, source } =
      filters;
                  ...
                  <div className="checkbox-container">
                    <label className="select-all">
                      <input
                        type="checkbox"
                        checked={
                          volatilityFilterState.cities.length ===
                          citiesList.length
                        }
        ...
        <div className="col-md-9">
          ...
          >
            ...
            <div className="card-body" style={{ height: "550px" }}>
              ...
              <div
                className="volatility-container"
                style={{
                  height: "450px",
                  overflowY: "hidden",
                  overflowX: "auto",
